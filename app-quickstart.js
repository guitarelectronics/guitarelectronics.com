...
//				app.u.dump("BEGIN myRIA.u.showProd ["+pid+"]");
				if(!app.u.isSet(pid))	{
					...
					if(pid.indexOf("WD1H10_") == 0 || pid.indexOf("WD1H11_") == 0 || pid.indexOf("WD1H5L1") == 0 || pid.indexOf("WD1H5R1") == 0 || pid.indexOf("WD2HH3T") == 0 || pid.indexOf("WD2HH3L") == 0 || pid.indexOf("WD2HH5R") == 0 || pid.indexOf("WD2HH5L") == 0 || pid.indexOf("WDUS") == 0 || pid.indexOf("WDUH") == 0 || pid.indexOf("WIRING_MOD_") == 0){
...
//best practice would be to NOT call this function directly. call showContent.
			...
			showPage : function(infoObj)	{
				...
				if(!catSafeID)	{
					...
					else if(catSafeID == '.wiring_resources_guitar_wiring_diagrams.1_pickup_guitar_wiring_diagrams' || catSafeID == ".wiring_resources_guitar_wiring_diagrams.guitar_wiring_mods"){
